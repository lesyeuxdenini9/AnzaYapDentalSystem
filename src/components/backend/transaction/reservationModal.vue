        ...
        <div class="modal" ref="bankModal" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-lg" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title"><span class="fa fa-calendar"></span> Followup Reservation</h5>
...
export default {
    ...
    methods: {
        ...
        save: function(){
                this.filterData.transaction = this.transaction
                this.createFollowupReservation(this.filterData)
                    .then((res)=>{
                         if(res.data.errors){
                        ...
                        // this.$store.dispatch('staff/getStaffList',{usertype: 1})
                            this.$mysocket.emit('updatePatientNotification',{privateID: `patient_${this.transaction.userId}`})
                            // this.closethis()
                            this.$emit("init")
                            this.init()
