        ...
        <div class="modal" ref="bankModal" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-md" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title"><span class="fa fa-edit"></span> Edit Service</h5>
...
export default {
    ...
    data: function(){
        return {
             service: JSON.parse(JSON.stringify(this.editInfo)),
             errormsg: [],
        }
    },
    methods: {
        ...
        save: function(){
             this.$store.dispatch("service/update",this.service)
             .then((res)=>{
                   if(res.data.errors){
