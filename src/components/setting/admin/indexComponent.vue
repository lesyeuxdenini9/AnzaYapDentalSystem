<template>
    <div> 
        ...
        <div class="container-fluid">
                  <span class="pageheader"><i class="fa fa-users"></i> Admin List</span>
        ...
        <editModal :activebranchIndex="activebranchIndex" :type="0" :editInfo="editInfo" v-if="showeditModal" @closemodal="closemodal()" @refreshlist="refreshlist"/>
    ...
    methods: {
        ...
        ...mapActions('user',[
         ...
         changearchive: function(){
          this.$store.dispatch("branch/getListUserByArchive",{usertype:0,archive: this.archiveStatus})
         },
        printPDF: function(){
