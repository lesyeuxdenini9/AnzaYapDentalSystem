    ...
    methods: {
        ...
        donePie: function(){
            ...
            let data = this.appointments.data.map((appointment)=>{
                return [`${this.months[appointment.monthname-1].des} ${appointment.yearname}`,appointment.Approved,appointment.Cancelled,appointment.Reschedule,appointment.totalcount]
            })
